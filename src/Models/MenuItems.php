...
namespace LaravelMenu\Menu\Models;
...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('LaravelMenu\Menu\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('LaravelMenu\Menu\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}
