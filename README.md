...
Reference Link: "https://packagist.org/packages/harimayco/laravel-menu"
...
```php
LaravelMenu\Menu\MenuServiceProvider::class,
```

3. add facade in the file config/app.php (optional on laravel 5.5)

```php
'Menu' => LaravelMenu\Menu\Facades\Menu::class,
```

4. Run publish

```php
php artisan vendor:publish --provider="LaravelMenu\Menu\MenuServiceProvider"
```
...
```php
use LaravelMenu\Menu\Models\Menus;
use LaravelMenu\Menu\Models\MenuItems;
...
```php
use LaravelMenu\Menu\Facades\Menu;
...
/*
Parameter: Menu ID
Return: Array
